...
const Hero = () => {
  return (
    <section
      id="home"
      className="section-padding bg-gradient-to-br from-background via-secondary/30 to-background min-h-screen flex items-center"
    >
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <p className="text-lg text-muted-foreground max-w-xl leading-relaxed">
              I design and develop intelligent solutions that combine AI,
              full-stack development, and modern cloud technologies. From
              chatbots and RAG systems to scalable web apps, I build tools that
            ...
            <div className="flex items-center gap-4 pt-4">
              ...
              <div className="flex gap-3">
                ...
                <Button
                  ...
                  asChild
                >
                  <a href="mailto:amanraj6221@gmail.com">
                    <Mail size={20} />
                  </a>
                </Button>
              </div>
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-r from-primary to-accent p-1 rounded-full">
                <img
                  src={profilePhoto}
                  alt="Aman - AI & Full-Stack Developer"
